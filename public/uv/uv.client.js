                ...
                Object.defineProperty(s, "defaultMaxListeners", {
                    ...
                    (s.prototype.emit = function (t) {
                        ...
                        if (o) {
                            var n;
                            if (
                                (e.length > 0 && (n = e[0]), n instanceof Error)
                            )
                                throw n;
                            var a = new Error(
                                "Unhandled error." +
            ...
            overrideAttribute() {
                this.ctx.override(this.elemProto, "getAttribute", (t, r, i) => {
                    ...
                    return (
                        ...
                        s.intercepted
                            ? s.returnValue
                            : s.target.call(s.that, s.data.name)
                    );
                }),
                    this.ctx.override(
                        this.elemProto,
            ...
            overrideAppend() {
                this.ctx.override(this.nodeProto, "append", (t, r, [...i]) => {
                    ...
                    return (
                        ...
                        o.intercepted
                            ? o.returnValue
                            : o.target.call(o.that, o.data.nodes)
                    );
                }),
                    this.ctx.override(
                        this.nodeProto,
            ...
            overrideNameValue() {
                this.ctx.overrideDescriptor(this.attrProto, "name", {
                    ...
                    this.ctx.overrideDescriptor(this.attrProto, "value", {
                        ...
                        set: (t, r, [i]) => {
                            const o = new e(
                                { name: this.name.get.call(r), value: i },
                                t,
                                r
                            );
            ...
            overrideRequest() {
                return (
                    ...
                    (this.ctx.override(this.window, "fetch", (t, r, i) => {
                        if (!i.length || i[0] instanceof this.Request)
                            return t.apply(r, i);
                        let [o, s = {}] = i;
            ...
            overrideSend() {
                this.ctx.override(this.xhrProto, "send", (t, r, [i = null]) => {
                    ...
                    return (
                        ...
                        o.intercepted
                            ? o.returnValue
                            : o.target.call(o.that, o.data.body)
                    );
                });
            }
            ...
            overrideGo() {
                this.ctx.override(this.historyProto, "go", (t, r, [i]) => {
                    ...
                    return (
                        ...
                        o.intercepted
                            ? o.returnValue
                            : o.target.call(o.that, o.data.delta)
                    );
                });
            }
            overrideForward() {
            ...
            emulate(t, e) {
                ...
                return (
                    "reload" in this.location &&
                        this.ctx.nativeMethods.defineProperty(r, "reload", {
                            value: this.ctx.wrap(
                                this.location,
                                "reload",
                                (t, e) => t.call(e === r ? this.location : e)
                            ),
                            writable: !1,
                            enumerable: !0,
                        }),
                    ...
                    this.ctx.nativeMethods.defineProperty(
                        r,
                        Symbol.toPrimitive,
                        { value: () => r.href, writable: !1, enumerable: !1 }
                    ),
            ...
            overrideObjectURL() {
                this.ctx.override(this.URL, "createObjectURL", (t, r, i) => {
                    ...
                    return (
                        ...
                        s.intercepted
                            ? s.returnValue
                            : s.target.call(s.that, s.data.object)
                    );
                }),
                    this.ctx.override(
                        this.URL,
                        ...
                        (t, r, i) => {
                            ...
                            return (
                                ...
                                s.intercepted
                                    ? s.returnValue
                                    : s.target.call(s.that, s.data.url)
                            );
                        }
                    );
            }
        ...
        const y = class extends t {
            ...
            overrideMethods() {
                this.ctx.override(this.storeProto, "getItem", (t, r, i) => {
                    ...
                    this.ctx.override(this.storeProto, "setItem", (t, r, i) => {
                        if (2 > i.length)
                            return t.apply(this.wrappers.get(r) || r, i);
                        let [o, s] = i;
                        const n = new e(
                            { name: o, value: s },
                            t,
            ...
            emulate(t, r = {}) {
                ...
                const i = new this.ctx.window.Proxy(r, {
                    get: (r, i) => {
                        if (i in this.storeProto || "symbol" == typeof i)
                            return t[i];
            ...
            overrideSend() {
                this.ctx.override(this.wsProto, "send", (t, r, i) => {
                    ...
                    return (
                        ...
                        o.intercepted
                            ? o.returnValue
                            : o.target.call(o.that, o.data.args)
                    );
                });
            }
        };
                ...
                super(),
                    ...
                    (this.nativeMethods = {
                        ...
                        getOwnPropertyDescriptors: this.window.Object
                            .getOwnPropertyDescriptors,
                        getOwnPropertyNames: this.window.Object
                            .getOwnPropertyNames,
                        keys: this.window.Object.keys,
                        getOwnPropertySymbols: this.window.Object
