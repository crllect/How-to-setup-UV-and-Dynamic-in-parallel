(() => {
    ...
    function l(i) {
        ...
        v.nativeMethods.defineProperty(c.meta, "base", {
            get: () =>
                i.document
                    ? (v.node.baseURI.get.call(i.document) !== x &&
                          ((x = v.node.baseURI.get.call(i.document)),
                          (O = c.sourceUrl(x))),
                      O)
                    : c.meta.url.href,
        }),
            ...
            v.message.on("postMessage", (e) => {
                ...
                e.that && (a = e.that.__uv$source.call),
                    ...
                    (e.data.message = {
                        __data: e.data.message,
                        __origin: (e.that || e.target).__uv$source.location
                            .origin,
                        __to: t,
                    }),
                    e.respondWith(
            ...
            v.element.on("setAttribute", (e) => {
                ...
                c.attrs.isUrl(e.data.name) &&
                    ...
                    c.attrs.isSrcset(e.data.name) &&
                        ...
                        (e.data.value = c.html.wrapSrcset(
            ...
            v.element.hookProperty([M], "srcset", {
                get: (e, t) =>
                    v.element.getAttribute.call(
                        t,
                        c.attributePrefix + "-attr-srcset"
                    ) || e.call(t),
                set: (e, t, [a]) => {
                    v.element.setAttribute.call(
                        t,
        ...
        const L =
            w &&
            Object.getOwnPropertyDescriptor(w.prototype, "contentWindow").get;
        function E(e) {
            const t = L.call(e);
            if (!t.__uv)
                try {
        ...
        if (
            ...
            v.document.on("setDomain", (e) => {
                if (
                    !e.data.value
                        .toString()
                        .endsWith(
                            c.meta.url.hostname.split(".").slice(-2).join(".")
                        )
                )
            ...
            v.storage.on("delete", (e) => {
                e.that.__uv$storageObj &&
                    delete e.that.__uv$storageObj[e.data.name],
                    (e.data.name = u + c.meta.url.origin + "@" + e.data.name);
            }),
            ...
            v.function.on("toString", (e) => {
                c.methods.string in e.that &&
                    e.respondWith(e.that[c.methods.string]);
            }),
            v.object.on("getOwnPropertyNames", (e) => {
                e.data.names = e.data.names.filter(
                    (e) => !c.filterKeys.includes(e)
                );
            }),
            ...
            for (const e of v.style.urlProps)
                v.overrideDescriptor(i.CSS2Properties.prototype, e, {
                    ...
                    set: (e, t, a) => {
                        e.call(
                            t,
                            c.rewriteCSS(a, { context: "value", ...c.meta })
                        );
                    },
                });
        else
        ...
        v.style.on("setCssText", (e) => {
            ...
            v.nativeMethods.defineProperty(
                i.Object.prototype,
                c.methods.source,
                { value: c, writable: !0, enumerable: !1 }
            ),
            v.nativeMethods.defineProperty(
                i.Object.prototype,
                c.methods.location,
